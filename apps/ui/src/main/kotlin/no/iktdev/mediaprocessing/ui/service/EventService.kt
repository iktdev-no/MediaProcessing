...
import no.iktdev.mediaprocessing.ui.models.internal.DeleteResult
...
import no.iktdev.mediaprocessing.ui.models.contract.LineageNode
import no.iktdev.mediaprocessing.ui.dto.SequenceEvent
import no.iktdev.mediaprocessing.ui.toDto
...
class EventService {
    ...
    fun deleteTaskResultForReset(referenceId: UUID, taskId: UUID): UUID? {
