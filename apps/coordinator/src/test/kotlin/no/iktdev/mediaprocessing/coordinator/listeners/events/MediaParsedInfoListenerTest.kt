    ...
    companion object {
        ...
        fun parseVideoTypeCases() = listOf(
            ...
            Named.of(
                ...
                ParseVideoTypeTestCase(
                    file = IFile("Potato harvesting Season 1 Episode 5 720p WEB-DL.mkv"),
                    expectedType = MediaType.Serie
                )
            ),
            Named.of(
                ...
                ParseVideoTypeTestCase(
                    file = IFile("Potato harvesting S1 - Episode 5 720p WEB-DL.mkv"),
                    expectedType = MediaType.Serie
                )
            ),
            Named.of(
                ...
                ParseVideoTypeTestCase(
                    file = IFile("Potato harvesting S1 - E5 720p WEB-DL.mkv"),
                    expectedType = MediaType.Serie
                )
            ),
            Named.of(
            ...
            Named.of(
                ...
                ParseVideoTypeTestCase(
                    file = IFile("weird_show.s01e02.720p.mkv"),
                    expectedType = MediaType.Serie
                )
            ),
            Named.of(
                ...
                ParseVideoTypeTestCase(
                    file = IFile("Some Show Season 02 Episode 09 1080p.mkv"),
                    expectedType = MediaType.Serie
                )
            ),
            Named.of(
                "1x02 style",
                ParseVideoTypeTestCase(
                    file = IFile("Show.Name.1x02.HDTV.mp4"),
                    expectedType = MediaType.Serie
                )
            ),
            Named.of(
                ...
                ParseVideoTypeTestCase(
                    file = IFile("ShowNameSeason03Episode04.avi"),
                    expectedType = MediaType.Serie
                )
            ),
            Named.of(
                ...
                ParseVideoTypeTestCase(
                    file = IFile("Some.Movie.Title.1999.720p.BluRay.x264-GROUP.mkv"),
                    expectedType = MediaType.Movie
                )
            ),
            Named.of(
                ...
                ParseVideoTypeTestCase(
                    file = IFile("a_movie_trailer_2017_sample.mp4"),
                    expectedType = MediaType.Movie
                )
            ),
            Named.of(
